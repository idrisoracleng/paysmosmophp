...
function gmgetdate($ts = null){
	...
	//return(array_comb($k,split(":",gmdate('s:i:G:j:w:n:Y:z:l:F:U',is_null($ts)?time():$ts)))); LGBN
...
function array_comb($array1, $array2) {
	...
	return $out;*/ // Updated to PHP5, LGBN

    return array_combine($array2, $array1);
}
