...
?>
<?php $id = uniqid(); ?>
<div class="col-xs-6 text-center rounded mt-2 product" id="<?php echo $id; ?>">
    <a href="<?php echo site_url('/product/'.str_replace([' ', "'", '&'], ['-', '_', 'and'], strtolower($name))).$attachment?>">
        <img class="card-img center lazy rounded-lg" data-src="<?php echo site_url('/public/images/products/'.$code.'/01.jpg'); ?>" src="<?php echo site_url('assets/images/ajax-loader.gif'); ?>" style="height: 100px; object-fit: contain;" alt="<?php echo $name; ?>"/>
    </a>
    <div>
    <a href="<?php echo site_url('/product/'.str_replace([' ', "'", '&'], ['-', '_', 'and'], strtolower($name)))?>">
