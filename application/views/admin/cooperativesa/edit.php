  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        <button class="btn btn-sm btn-primary back_btn"><i class="fas fa-arrow-left"></i></button> Add New Cooperative <a class="btn btn-sm btn-primary" href="<?php echo site_url('admin/cooperatives/cooperatives') ?>" style="float: right"> All Cooperative <span class="fa fa-plus"></span></a></div>
      <div class="card-body">
