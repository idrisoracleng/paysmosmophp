...
<div id="content-wrapper">
    ...
    <!-- Breadcrumbs-->
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a class="btn btn-danger back-btn">Cancel</a>
                <button class="btn btn-success save_product"><span class="fa fa-check"></span> Save Item</button>
            </div>
        </div>
    
        <form class="form" method="POST" action="<?php echo site_url('/seller/product/store'); ?>" enctype="multipart/form-data" id="product_form" msg="Cloning product">
            ...
            <div class="panel card mb-3">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input id="option_name" class="form-control input-sm" placeholder="Input option name: color, size"/>            
                    </div>
                    <?php $productOptions = $this->db->query('SELECT * FROM product_options WHERE product_id = "'.$product['product_id'].'"')->result_array(); ?>
                    <?php if ($productOptions) { ?>
                        <?php foreach ($productOptions as $key => $productOption) { ?>
                        <div class="form-group col-md-3">
                            <label><?php echo $productOption['option_title'] ?></label>
                            <input name="option_values[]" class="form-control input-sm" placeholder="Input option name: color, size" value="<?php echo $productOption['option_values'] ?>"/>            
                            <input type="hidden" name="option_names[]" class="form-control input-sm" placeholder="Input option name: color, size" value="<?php echo $productOption['option_title'] ?>"/>            
                            <input type="hidden" name="option_id[]" class="form-control input-sm" placeholder="Input option name: color, size" value="<?php echo $productOption['id'] ?>"/>         
                        </div>
                        <?php } ?>
                    <?php } ?>
                    </div>
                    <div>
                    <button class="btn btn-small btn-primary fa fa-plus" id="add_product_option">Add</button>
                    </div>
                </div>
                </div>
            </div>
